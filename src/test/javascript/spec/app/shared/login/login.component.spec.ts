...
import { FafiLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: FafiLoginModalComponent;
        let fixture: ComponentFixture<FafiLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [FafiLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(FafiLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(FafiLoginModalComponent);
