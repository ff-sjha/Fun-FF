...
import { FafiHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { FafiHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('FafiHealthCheckComponent', () => {

        let comp: FafiHealthCheckComponent;
        let fixture: ComponentFixture<FafiHealthCheckComponent>;
        let service: FafiHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [FafiTestModule],
                declarations: [FafiHealthCheckComponent],
                providers: [
                    FafiHealthService
                ]
            })
            .overrideTemplate(FafiHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(FafiHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(FafiHealthService);
        });
