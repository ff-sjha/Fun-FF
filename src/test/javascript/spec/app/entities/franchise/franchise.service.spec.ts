...
describe('Service Tests', () => {
    ...
    describe('Franchise Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FranchiseService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/franchises/' + 123);
            });
            it('should return Franchise', () => {

                let entity: Franchise;
                service.find(123).subscribe((_entity: Franchise) => {
                    entity = _entity;
                });
