...
describe('Service Tests', () => {
    ...
    describe('TournamentFranchisePoints Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TournamentFranchisePointsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/tournament-franchise-points/' + 123);
            });
            it('should return TournamentFranchisePoints', () => {

                let entity: TournamentFranchisePoints;
                service.find(123).subscribe((_entity: TournamentFranchisePoints) => {
                    entity = _entity;
                });
