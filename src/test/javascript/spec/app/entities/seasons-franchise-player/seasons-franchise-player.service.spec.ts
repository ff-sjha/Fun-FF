...
describe('Service Tests', () => {
    ...
    describe('SeasonsFranchisePlayer Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SeasonsFranchisePlayerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/seasons-franchise-players/' + 123);
            });
            it('should return SeasonsFranchisePlayer', () => {

                let entity: SeasonsFranchisePlayer;
                service.find(123).subscribe((_entity: SeasonsFranchisePlayer) => {
                    entity = _entity;
                });
