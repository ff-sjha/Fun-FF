...
/**
 * Service for executing complex queries for SeasonsFranchise entities in the database.
 * The main input is a {@link SeasonsFranchiseCriteria} which get's converted to {@link Specifications},
 * in a way that all the filters must apply.
 * It returns a {@link List} of {@link SeasonsFranchiseDTO} or a {@link Page} of {@link SeasonsFranchiseDTO} which fulfills the criteria.
 */
@Service
...
public class SeasonsFranchiseQueryService extends QueryService<SeasonsFranchise> {
    ...
    public SeasonsFranchiseQueryService(SeasonsFranchiseRepository seasonsFranchiseRepository, SeasonsFranchiseMapper seasonsFranchiseMapper) {
        this.seasonsFranchiseRepository = seasonsFranchiseRepository;
        this.seasonsFranchiseMapper = seasonsFranchiseMapper;
    }

    /**
     * Return a {@link List} of {@link SeasonsFranchiseDTO} which matches the criteria from the database
    ...
    /**
     * Return a {@link Page} of {@link SeasonsFranchiseDTO} which matches the criteria from the database
     * @param criteria The object which holds all the filters, which the entities should match.
    ...
    private Specifications<SeasonsFranchise> createSpecification(SeasonsFranchiseCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getSeasonId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getSeasonId(), SeasonsFranchise_.season, Season_.id));
            }
            if (criteria.getFranchiseId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getFranchiseId(), SeasonsFranchise_.franchise, Franchise_.id));
            }
            if (criteria.getOwnerId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getOwnerId(), SeasonsFranchise_.owner, Player_.id));
            }
            if (criteria.getIconPlayerId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getIconPlayerId(), SeasonsFranchise_.iconPlayer, Player_.id));
            }
        }
