        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.matchService.find(id).subscribe((match) => {
                    match.startDateTime = this.datePipe
                        .transform(match.startDateTime, 'yyyy-MM-ddTHH:mm:ss');
                    match.endDateTime = this.datePipe
                        .transform(match.endDateTime, 'yyyy-MM-ddTHH:mm:ss');
